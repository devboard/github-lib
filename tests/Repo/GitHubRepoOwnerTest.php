    ...
    public function provideArguments(): array
    {
        return [
            [
                ...
                new User(),
                new GitHubAccountAvatarUrl('https://avatars.Usercontent.com/u/13507412?v=3'),
            ...
            [
                ...
                new Organization(),
                new GitHubAccountAvatarUrl('https://avatars.Usercontent.com/u/13396338?v=3'),
                new GitHubAccountGravatarId(''),
            ...
            [
                ...
                new User(),
                new GitHubAccountAvatarUrl('https://avatars.Usercontent.com/u/1?v=3'),
                new GitHubAccountGravatarId(''),
