 ...
 */
class CommitAuthorDetailsTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSerializationAndDeserialization(
        ...
        $this->assertEquals($sut, CommitAuthorDetails::deserialize($serialized));
    }
